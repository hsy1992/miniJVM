...
/**
 * The Long class wraps a value of the primitive type <code>long</code> in an
 * object. An object of type <code>Long</code> contains a single field whose
 * type is <code>long</code>.
 * <p>
...
public final class Long {
     ...
     * and <tt>'&#92;u0061'</tt> through <tt>'&#92;u007a'</tt>. If the radix is
     ...
     * string, exactly as if the argument and the radix 10 were given as
     * arguments to the {@link #toString(long, int)} method that takes two
     * arguments.
     *
     ...
     * <code>Character.digit</code> returns a nonnegative value), except that
     * the first character may be an ASCII minus sign <code>'-'</code>
     * (<tt>'&#92;u002d'</tt> to indicate a negative value. The resulting
     * <code>long</code> value is returned.
     * <p>
     * Note that neither <tt>L</tt> nor <tt>l</tt> is permitted to appear at the
     * end of the string as a type indicator, as would be permitted in Java
     * programming language source code - except that either <tt>L</tt>
     ...
     * <li>The first character of the string is not a digit of the specified
     * <tt>radix</tt> and is not a minus sign <tt>'-'</tt>
     * (<tt>'&#92;u002d'</tt>).
     * <li>The first character of the string is a minus sign and the string is
     * of length 1.
     * <li>Any character of the string after the first is not a digit of the
     * specified <tt>radix</tt>.
     * <li>The integer value represented by the string cannot be represented as
     ...
     * <tt>10</tt> were given as arguments to the
     ...
     * primitive <code>long</code> argument.
     *
     ...
     *
     * @return the <code>long</code> value represented by this object that is
    ...
    /**
     * Returns a String object representing this Long's value. The long integer
     * value represented by this Long object is converted to signed decimal
     * representation and returned as a string, exactly as if the long value
     * were given as an argument to the {@link #toString(long)} method that
     * takes one argument.
     *
    ...
    /**
     * Computes a hashcode for this Long. The result is the exclusive OR of the
     * two halves of the primitive <code>long</code> value represented by this
