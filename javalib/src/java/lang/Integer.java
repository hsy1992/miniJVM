 ...
 * <code>int</code> to a <code>String</code> and a <code>String</code> to an
 * <code>int</code>, as well as other constants and methods useful when dealing
 * with an <code>int</code>.
 *
 * @author Lee Boynton
...
public final class Integer {
     ...
     * ASCII minus character <code>'-'</code> (<tt>'&#92;u002d'</tt>). If the
     ...
     * zero character <tt>'0'</tt> (<tt>'&#92;u0030'</tt>); otherwise, the first
     * character of the representation of the magnitude will not be the zero
     ...
     * it is represented by a single zero character <tt>'0'</tt>
     * (<tt>'&#92;u0030'</tt>); otherwise, the first character of the
     ...
     * zero character. The octal digits are:
     * <blockquote><pre>
     * 01234567
     * </pre></blockquote>
     * These are the characters <tt>'&#92;u0030'</tt> through
     ...
     * character <tt>'0'</tt> (<tt>'&#92;u0030'</tt>); otherwise, the first
     * character of the representation of the unsigned magnitude will not be the
     * zero character. The characters <tt>'0'</tt>
     ...
     * arguments to the {@link #toString(int, int)} method.
     *
     ...
     * may be an ASCII minus sign <code>'-'</code> (<tt>'&#92;u002d'</tt>) to
     * indicate a negative value. The resulting integer value is returned,
     * exactly as if the argument and the radix 10 were given as arguments to
     * the {@link #parseInt(java.lang.String, int)} method.
     *
     * @param s a string.
     ...
     * String. The first argument is interpreted as representing a signed
     ...
     * method. The result is an <code>Integer</code> object that represents the
     * integer value specified by the string.
     * <p>
     * In other words, this method returns an <code>Integer</code> object equal
     * to the value of:
     * <blockquote><pre>
     ...
     * <tt>s</tt>
     * @return a newly constructed <code>Integer</code> initialized to the value
     ...
     * <tt>Integer</tt> object that represents the integer value specified by
     * the string.
     * <p>
     * In other words, this method returns an <tt>Integer</tt> object equal to
     * the value of:
     * <blockquote><pre>
     ...
     * <tt>int</tt> value represented by this
     ...
     * and is an <code>Integer</code> object that contains the same
