...
import static org.mini.glfw.utils.Nanovg.NVG_ALIGN_CENTER;
import static org.mini.glfw.utils.Nanovg.NVG_ALIGN_LEFT;
import static org.mini.glfw.utils.Nanovg.NVG_ALIGN_MIDDLE;
import static org.mini.glfw.utils.Nanovg.NVG_ALIGN_RIGHT;
import static org.mini.glfw.utils.Nanovg.NVG_ALIGN_TOP;
import static org.mini.glfw.utils.Nanovg.NVG_ANTIALIAS;
import static org.mini.glfw.utils.Nanovg.NVG_BEVEL;
import static org.mini.glfw.utils.Nanovg.NVG_BUTT;
import static org.mini.glfw.utils.Nanovg.NVG_CCW;
import static org.mini.glfw.utils.Nanovg.NVG_CW;
import static org.mini.glfw.utils.Nanovg.NVG_DEBUG;
import static org.mini.glfw.utils.Nanovg.NVG_HOLE;
import static org.mini.glfw.utils.Nanovg.NVG_MITER;
import static org.mini.glfw.utils.Nanovg.NVG_ROUND;
import static org.mini.glfw.utils.Nanovg.NVG_SQUARE;
import static org.mini.glfw.utils.Nanovg.NVG_STENCIL_STROKES;
import static org.mini.glfw.utils.Nanovg.nvgAddFallbackFontId;
import static org.mini.glfw.utils.Nanovg.nvgArc;
import static org.mini.glfw.utils.Nanovg.nvgBeginFrame;
import static org.mini.glfw.utils.Nanovg.nvgBeginPath;
import static org.mini.glfw.utils.Nanovg.nvgBezierTo;
import static org.mini.glfw.utils.Nanovg.nvgBoxGradient;
import static org.mini.glfw.utils.Nanovg.nvgCircle;
import static org.mini.glfw.utils.Nanovg.nvgClosePath;
import static org.mini.glfw.utils.Nanovg.nvgCreateFont;
import static org.mini.glfw.utils.Nanovg.nvgCreateNVGglyphPosition;
import static org.mini.glfw.utils.Nanovg.nvgCreateNVGtextRow;
import static org.mini.glfw.utils.Nanovg.nvgDegToRad;
import static org.mini.glfw.utils.Nanovg.nvgEllipse;
import static org.mini.glfw.utils.Nanovg.nvgEndFrame;
import static org.mini.glfw.utils.Nanovg.nvgFill;
import static org.mini.glfw.utils.Nanovg.nvgFillColor;
import static org.mini.glfw.utils.Nanovg.nvgFillPaint;
import static org.mini.glfw.utils.Nanovg.nvgFontBlur;
import static org.mini.glfw.utils.Nanovg.nvgFontFace;
import static org.mini.glfw.utils.Nanovg.nvgFontSize;
import static org.mini.glfw.utils.Nanovg.nvgGlobalAlpha;
import static org.mini.glfw.utils.Nanovg.nvgHSLA;
import static org.mini.glfw.utils.Nanovg.nvgImagePattern;
import static org.mini.glfw.utils.Nanovg.nvgImageSize;
import static org.mini.glfw.utils.Nanovg.nvgIntersectScissor;
import static org.mini.glfw.utils.Nanovg.nvgLineCap;
import static org.mini.glfw.utils.Nanovg.nvgLineJoin;
import static org.mini.glfw.utils.Nanovg.nvgLineTo;
import static org.mini.glfw.utils.Nanovg.nvgLinearGradient;
import static org.mini.glfw.utils.Nanovg.nvgMoveTo;
import static org.mini.glfw.utils.Nanovg.nvgNVGglyphPosition_x;
import static org.mini.glfw.utils.Nanovg.nvgPathWinding;
import static org.mini.glfw.utils.Nanovg.nvgRadialGradient;
import static org.mini.glfw.utils.Nanovg.nvgRect;
import static org.mini.glfw.utils.Nanovg.nvgResetScissor;
import static org.mini.glfw.utils.Nanovg.nvgRestore;
import static org.mini.glfw.utils.Nanovg.nvgRotate;
import static org.mini.glfw.utils.Nanovg.nvgRoundedRect;
import static org.mini.glfw.utils.Nanovg.nvgSave;
import static org.mini.glfw.utils.Nanovg.nvgScale;
import static org.mini.glfw.utils.Nanovg.nvgScissor;
import static org.mini.glfw.utils.Nanovg.nvgStroke;
import static org.mini.glfw.utils.Nanovg.nvgStrokeColor;
import static org.mini.glfw.utils.Nanovg.nvgStrokeWidth;
import static org.mini.glfw.utils.Nanovg.nvgTextJni;
import static org.mini.glfw.utils.Nanovg.nvgTextAlign;
import static org.mini.glfw.utils.Nanovg.nvgTextBoundsJni;
import static org.mini.glfw.utils.Nanovg.nvgTextBoxBoundsJni;
import static org.mini.glfw.utils.Nanovg.nvgTextBoxJni;
import static org.mini.glfw.utils.Nanovg.nvgTextBreakLinesJni;
import static org.mini.glfw.utils.Nanovg.nvgTextGlyphPositionsJni;
import static org.mini.glfw.utils.Nanovg.nvgTextLineHeight;
import static org.mini.glfw.utils.Nanovg.nvgTextMetrics;
import static org.mini.glfw.utils.Nanovg.nvgTranslate;
...
//  
    ...
    void init() {
        vg = Nanovg.nvgCreateGL2(NVG_ANTIALIAS | NVG_STENCIL_STROKES | NVG_DEBUG);
        if (vg == 0) {
...
//	nvgFillColor(vg, nvgRGBA(0,0,0,128));
    ...
    void drawEditBoxNum(long vg,
        ...
        uw = Nanovg.nvgTextBoundsJni(vg, 0f, 0f, b1, 0, b1.length, null);
    ...
    void drawButton(long vg, int preicon, String text, float x, float y, float w, float h, float[] col) {
        ...
        bg = Nanovg.nvgLinearGradient(vg, x, y, x, y + h, nvgRGBA(255, 255, 255, isBlack(col) ? 16 : 32), nvgRGBA(0, 0, 0, isBlack(col) ? 16 : 32));
        nvgBeginPath(vg);
        nvgRoundedRect(vg, x + 1, y + 1, w - 2, h - 2, cornerRadius - 1);
        if (!isBlack(col)) {
            nvgFillColor(vg, col);
        ...
        nvgFontFace(vg, fontname);
        byte[] b2 = toUtf8(text);
        tw = Nanovg.nvgTextBoundsJni(vg, 0, 0, b2, 0, b2.length, null);
        byte[] b3 = cpToUTF8(preicon);
        if (preicon != 0) {
            nvgFontSize(vg, h * 1.3f);
            nvgFontFace(vg, iconname);
            iw = Nanovg.nvgTextBoundsJni(vg, 0, 0, b3, 0, b3.length, null);
            iw += h * 0.15f;
        }
...
//	nvgClearState(vg);
        ...
        // Drop shadow
        shadowPaint = Nanovg.nvgBoxGradient(vg, x, y + 4, w, h, cornerRadius * 2, 20, nvgRGBA(0, 0, 0, 128), nvgRGBA(0, 0, 0, 0));
        nvgBeginPath(vg);
        nvgRect(vg, x - 10, y - 10, w + 20, h + 30);
        nvgRoundedRect(vg, x, y, w, h, cornerRadius);
        nvgPathWinding(vg, NVG_HOLE);
    ...
    void drawParagraph(long vg, float x, float y, float width, float height, float mx, float my) {
        ...
        while ((nrows = nvgTextBreakLinesJni(vg, text_arr, start, end, width, rows, rowCount)) != 0) {
            for (i = 0; i < nrows; i++) {
                ...
                float row_width = Nanovg.nvgNVGtextRow_width(rows, i);
                nvgBeginPath(vg);
                nvgFillColor(vg, nvgRGBA(255, 255, 255, hit ? 64 : 16));
                nvgRect(vg, x, y, row_width, lineh[0]);
                nvgFill(vg);

                int starti = (int) (Nanovg.nvgNVGtextRow_start(rows, i) - ptr);
                int endi = (int) (Nanovg.nvgNVGtextRow_end(rows, i) - ptr);
            ...
            long next = Nanovg.nvgNVGtextRow_next(rows, nrows - 1);
            start = (int) (next - ptr);
        }
        if (gutter != 0) {
        ...
        Nanovg.nvgDeleteNVGtextRow(rows);
