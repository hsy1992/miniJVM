 ...
 * @author gust
 */
public class Nutil_java_2_c {

    public static void main(String[] args) {
        Nutil_java_2_c gt = new Nutil_java_2_c();
        gt.buildC();
    }

    String[] path = {"src/org/mini/glfw/utils/Nutil.java", "org_mini_glfw_utils_Nutil_", "org/mini/glfw/utils/Nutil", "../jni_nutil.c"};
    ...
    void buildC() {
        ...
        try {
            ...
            Logger.getLogger(Nutil_java_2_c.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                br.close();
                bw.close();
