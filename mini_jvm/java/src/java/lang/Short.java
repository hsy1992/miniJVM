...
public final class Short {
     ...
     * value. Throws an exception if the String cannot be parsed as a short. The
    ...
    /**
     * Assuming the specified String represents a short, returns that short's
     * value in the radix specified by the second argument. Throws an exception
     * if the String cannot be parsed as a short.
     *
     * @param s the String containing the short
     * @param radix the radix to be used
     * @return The short value represented by the specified string in the
     * specified radix.
     * @exception NumberFormatException If the String does not contain a
     * parsable short.
     */
