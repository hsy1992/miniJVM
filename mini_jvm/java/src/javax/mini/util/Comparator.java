 ...
 * (such as <tt>TreeSet</tt> or <tt>TreeMap</tt>)
 * .<p>
 *
 ...
 * defined in terms of <tt>equals</tt>.<p>
 *
 * For example, if one adds two keys <tt>a</tt> and <tt>b</tt> such that
 * <tt>(a.equals((Object)b) && c.compare((Object)a, (Object)b) != 0)</tt> to a
 * sorted set with comparator <tt>c</tt>, the second <tt>add</tt> operation will
 * return false (and the size of the sorted set will not increase) because
 * <tt>a</tt> and <tt>b</tt> are equivalent from the sorted set's
 * perspective.<p>
 *
 ...
 * <i>total order</i> that a given comparator <tt>c</tt> imposes on a given set
 * of objects <tt>S</tt> is:
 * <pre>
 ...
 * natural ordering is a <i>total order</i> on <tt>S</tt>. When we say that the
