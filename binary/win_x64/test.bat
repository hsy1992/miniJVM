...
rem mini_jvm.exe -cp ../lib/minijvm_rt.jar;../lib/jni_test.jar test/JniTest
mini_jvm.exe -cp ../lib/minijvm_rt.jar;../lib/gui_lib.jar test/GuiTest
mini_jvm.exe -cp ../lib/minijvm_rt.jar;../lib/gui_lib.jar test/Light
